...
# §3.4.2 grounding 门控：AI 上一句"主动提出为用户调整自己作息"的信号词。
# 只有 AI 先提了要熬夜/多陪一会儿/晚点睡，用户随后的裸"好/嗯"才算作息调整；
# 否则按"证据缺失即弃权"降级为日常交流（防裸附和词误触，详见 CLAUDE.md §6 偏离表）。
AI_SCHEDULE_OFFER_CUES = (
    "再陪你", "多陪你", "陪你一会", "陪你一下", "陪你会", "陪你到", "陪你熬",
    "陪你久", "陪你多", "陪你聊到", "晚点睡", "晚些睡", "不睡了", "再熬",
    "熬夜陪", "我不困", "再聊一会", "再聊会", "多聊一会", "多聊会",
    "我推迟", "我调整作息", "要不要我陪", "要我陪", "我可以晚点", "我晚点",
)
