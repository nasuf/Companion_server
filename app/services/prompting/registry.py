...
PROMPT_DEFINITIONS = [
    ...
    PromptDefinition("memory.extraction_user", "用户长期记忆提取", "异步记忆", "记忆", "Spec §2.1：仅抽取用户侧记忆，存入 B 库 (memories_user)。", MEMORY_EXTRACTION_USER_PROMPT),
    PromptDefinition("memory.extraction_ai", "AI 自我长期记忆提取", "异步记忆", "记忆", "Spec §2.2：仅抽取 AI 自我记忆，存入 A 库 (memories_ai)。", MEMORY_EXTRACTION_AI_PROMPT),
