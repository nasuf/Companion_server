...
*   "明天提醒我开会" / "别忘了周五面试" / "记得下周三带资料" → main_category="生活", sub_category="提醒"（明确提醒请求+未来时间=提醒子类）
*   "下周二有面试" / "12月8日要考四级" / "下个月15号是结婚纪念日" → main_category="生活", sub_category="工作"或"教育"或"人际"（重要日期事件，必须填 occur_time）
*   AI 自述: "我下周三要去医院体检" / "明天我要面试" → owner="ai", main_category="生活", 必须填 occur_time（AI 自身的重要日期, spec Part 5 §4.1 写入 A 库）
