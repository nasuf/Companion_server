...
_PROMPT_FALLBACK_REGISTRATIONS: list[
    ...
    ("offline.shooting_conditions", "线下打卡拍摄条件生成", "data", _label_passthrough),
    ("offline.photo_recognition", "现场照片识图匹配", "data", _label_passthrough),
    ("offline.thought_fragment", "思绪碎片正文生成", "data", _label_reply_text),
