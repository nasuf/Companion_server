...
_MAIN_PROMPT_SECTION_COMPONENTS = [
    ...
    ("## 红包回应", "chat.red_packet_reply"),
    ("## 礼物回应", "chat.gift_reply"),
    ("## 话题上下文", "chat.topic_context_section"),
    ("## 一起听音乐", "chat.music_context_section"),
    ("## 当前线下活动", "chat.offline_activity_section"),
    ("## 时间\n", "chat.time_context_section"),
    ("## 事件时间线", "chat.timeline_section"),
...
_COMPONENT_ONLY_PROMPT_KEYS = {
    ...
    "chat.red_packet_reply",
    "chat.red_packet_user_message",
    "chat.gift_reply",
    "chat.gift_user_message",
...
_PROMPT_FALLBACK_REGISTRATIONS: list[
    ...
    ("expression.learn_style", "表达学习提取", "decision", _label_passthrough),
    ("chat.session_recap", "重逢摘要生成", "decision", _label_passthrough),
    ...
    ("offline.photo_match", "现场照片隐藏方向匹配", "data", _label_passthrough),
    ("offline.photo_followup_transition", "现场照片自然转场", "reply", _label_reply_text),
    ("offline.photo_followup_near", "现场照片顺势引导", "reply", _label_reply_text),
    ("offline.photo_followup_free_roam", "现场照片自由承接", "reply", _label_reply_text),
    ("offline.fragment_verbalize", "思绪碎片口语化交付", "reply", _label_reply_text),
    ("offline.arrival_guide", "到达拍照引导", "reply", _label_reply_text),
    ("offline.miss_hint", "未命中方向暗示", "reply", _label_reply_text),
    ("offline.activity_companion_decision", "活动持续陪伴决策", "data", _label_passthrough),
    ("offline.activity_companion_message", "活动持续陪伴文案", "reply", _label_reply_text),
    ("offline.safe_rewrite", "活动目标泄露重写", "reply", _label_reply_text),
    ("offline.memory_note", "记忆手札旅途小记", "data", _label_reply_text),
